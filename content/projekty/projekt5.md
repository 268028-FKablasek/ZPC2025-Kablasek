...
Jednotlivé součástky jsou mezi sebou propojeny vodiči přes breadbordu a napájeny napřímo z arduina.
 <img src="/ZPC2025-Kablasek/images/pocetelektro.png"
     alt="20"
     width="500" 
...
<img src="/ZPC2025-Kablasek/images/kod1.png"
     alt="22"
     width="500" 
...
<img src="/ZPC2025-Kablasek/images/kod2.png"
     alt="23"
     width="500" 
     style="position:absolute; right:2cm; top:40cm; border-radius:10px;">

**Třetí část** programu se zabývá ovládnim **Neopixel ringu** (červená=tečka, modrá=čárka), **Bzučáku** a délkou jednotlivých intervalů. Délka jednotlivých intervalů slouží pro vyzuální a zvukové rozeznání teček a čárek.  
...
<img src="/ZPC2025-Kablasek/images/kod4.png"
     alt="25"
     width="500" 
...
<img src="/ZPC2025-Kablasek/images/kod5.png"
     alt="26"
     width="500" 
